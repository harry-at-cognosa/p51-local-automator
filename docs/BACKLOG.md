...
- **Surface config_snapshot in the UI** — render it on the run detail page. NULL rows (pre-Phase 1) display as "config not captured (older run)." Markdown renderer landed in Phase F2 (`phase F2.1`); the panel itself ships in F3.
